...
/**
 * Group activity update post hook event class.
 *
...
/**
 * An event that fires when a user posts an activity update on a group.
 *
 * @since 1.0.0
 */
class WordPoints_BP_Hook_Event_Group_Activity_Update_Post
